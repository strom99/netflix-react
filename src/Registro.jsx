...
export function Registro({ changeView }) {
    ...
    const validatePassword = (e) => {
        ...
        if (e.target.value.length < 6) {
            e.target.setCustomValidity(`Minimo 6 caracteres(actualmente tiene ${e.target.value.length })`);
            setErrorPassw(false)
        }
            ...
            <div className='form'>
                <div className='setup'>
                    ...
                    <form id='form' onSubmit={validation}>
                            <input name='email' type="email" id='email' value={email} onInput={validateEmail} 
                            ...
                            <input type="password" id='password'
                                ...
                                required value={password} onInput={validatePassword} 
                                onBlur={validatePassword} 
                                placeholder="Introduce una contraseña"
                                />
                        <div className='check'>
                            <input type="checkbox" name="" id="" />
                            <label htmlFor="">Please do not email me Netflix special offers.</label>
                        </div>
